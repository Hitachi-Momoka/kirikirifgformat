...
[Serializable]
public record LineDataModel : IKrkrImageData
{
    ...
    public string Opacity { get; private set; }
    ...
    public string GroupLayerId { get; private set; }
    ...
    public static LineDataModel CreateFromLineString(string line)
    {
